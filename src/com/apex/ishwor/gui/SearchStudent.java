...
public class SearchStudent extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jcb.setModel(new javax.swing.DefaultComboBoxModel<>(new StudentDAO().getColumnName()));
    ...
    private void searchBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBttnActionPerformed
        ...
        try {
            table.setModel(new StudentDAO().searchStudent(field, value));
    ...
    private void loadColumnNames() {
        table.setModel(new DefaultTableModel(null, new StudentDAO().getCName()));
    }
